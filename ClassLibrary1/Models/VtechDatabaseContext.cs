...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.FormId).HasName("PK__Form__FB05B7DDCC6068EF");
            ...
            entity.HasMany(d => d.Students).WithMany(p => p.Forms)
                .UsingEntity<Dictionary<string, object>>(
                    "FormStudent",
                    r => r.HasOne<Student>().WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__FormStude__Stude__5629CD9C"),
                    l => l.HasOne<Form>().WithMany()
                        .HasForeignKey("FormId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__FormStude__FormI__5535A963"),
                    j =>
                    {
                        j.HasKey("FormId", "StudentId").HasName("PK__FormStud__7829E564083FB8E8");
                        j.ToTable("FormStudent");
                        j.IndexerProperty<string>("FormId")
                            .HasMaxLength(20)
                            .IsUnicode(false);
                    });
        });
        ...
        {
            entity.HasKey(e => e.StudentId).HasName("PK__Student__32C52B99D6980AE5");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasMany(d => d.Forms).WithMany(p => p.Users)
                .UsingEntity<Dictionary<string, object>>(
                    "UserForm",
                    r => r.HasOne<Form>().WithMany()
                        .HasForeignKey("FormId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__UserForm__FormId__59FA5E80"),
                    l => l.HasOne<User>().WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__UserForm__UserId__59063A47"),
                    j =>
                    {
                        j.HasKey("UserId", "FormId").HasName("PK__UserForm__D8389731E448A9B1");
                        j.ToTable("UserForm");
                        j.IndexerProperty<string>("FormId")
                            .HasMaxLength(20)
                            .IsUnicode(false);
